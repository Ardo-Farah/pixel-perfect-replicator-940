...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Kenya Health Emergency Dashboard" },
      { name: "description", content: "Live IDSR surveillance dashboard tracking disease outbreaks, nutrition, and emergencies across Kenya." },
      { property: "og:title", content: "Kenya Health Emergency Dashboard" },
      { property: "og:description", content: "Live IDSR surveillance dashboard tracking disease outbreaks, nutrition, and emergencies across Kenya." },
